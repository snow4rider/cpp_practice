...
/// @brief Create a SimpleStringOwner object with a string that exactly fits
/// the buffer
///
/// This function initializes a SimpleStringOwner with a string of length 10,
/// which precisely matches the buffer size of the SimpleStringOwner.
void
fn_c ()
{
...
/// @brief Create a SimpleStringOwner object with a string that has length 1
///
/// This function initializes a SimpleStringOwner with a string of length 1,
/// then calls fn_c to create a SimpleStringOwner with a string of length 10.
void
fn_b ()
{
